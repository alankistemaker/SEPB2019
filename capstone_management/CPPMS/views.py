...
def change_password(request):
    ...
    return render(request, 'change_password.html', {"count":count, "form": form, "username": username})
...
def Adduser(request):
    ...
    return render(request, 'adduser.html', {"count":count, "form": form, "username": username})
...
def profile_edit(request, template_name="profile_edit.html"):
   ...
   # return render(template_name, locals(),
    ...
    return render(request, template_name, {"count":count, "form": form, "username": username})
...
def proposal_detail(request, pk=None):
    ...
    return render(request, "proposal_detail.html", {"count":count, "proposal_detail": proposal_detail, "username": username, "project_filter": project_filter})
...
def generation_list(request, title=None):
    ...
    return render(request, "generation_list.html", {"count":count, "generation_filter": generation_filter, "filter_value": filter_value, "username": username})   
...
def project_detail(request, pk=None):
    ...
    return render(request, "project_detail.html", {"count":count, "project_detail": project_detail, "username": username,})
...
def client_detail(request, pk=None):
    ...
    return render(request, "client_detail.html", {"count":count, "proposal_filter": proposal_filter, "client_detail": client_detail, "username": username, "proposals": proposals})
...
def client_edit(request, pk=None):
    ...
    return render(request, "client_edit.html", {"count":count, "client_edit": client_edit, "username": username, "companies": companies})
...
def word_proposal(request):
    ...
    return render(request, "word_proposal.html", {"count":count, "uploaded_proposal": uploaded_proposal, "word_proposals": word_proposals, "username": username})
...
def word_detail(request, pk=None):
    ...
    return render(request, "word_detail.html", 
                  {"count":count, "proposal_detail": proposal_detail, "extract":extract,
                   ...
                   "supervisor_email":supervisor_email, "supervisor_title":supervisor_title, "username": username})